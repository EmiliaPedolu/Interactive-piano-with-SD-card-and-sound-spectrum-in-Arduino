        ...
        if (buttonState == HIGH) {
            ...
            switch (i) {
                case 0://button 10
                    ...
                    break;
                case 1: lcd.print("Note: Re#"); tone(buzzer, 587, 100); break;//button 9
                case 2: lcd.print("Note: Do#"); tone(buzzer, 523, 100); break;//button 8
                case 3: lcd.print("Note: Si"); tone(buzzer, 494, 100); break;//button 7
                case 4: lcd.print("Note: La"); tone(buzzer, 440, 100); break;//button 6
                case 5: lcd.print("Note: Sol"); tone(buzzer, 392, 100); break;//button 5
                case 6: lcd.print("Note: Fa"); tone(buzzer, 349, 100); break;//button 4
                case 7: lcd.print("Note: Mi"); tone(buzzer, 330, 100); break;//button 3
                case 8: lcd.print("Note: Re"); tone(buzzer, 294, 100); break;//button 2
                case 9: lcd.print("Note: Do"); tone(buzzer, 262, 100); break;//button 1
            }
        } else {
